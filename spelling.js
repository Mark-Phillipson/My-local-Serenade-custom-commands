const OPT={
	...
	serenade.global().key("alpha", "a",undefined,OPT.AUTO_ANY);
	serenade.global().key("bravo", "b",undefined,OPT.AUTO_ANY);
	serenade.global().key("charlie", "c",undefined,OPT.AUTO_ANY);
	serenade.global().key("delta", "d",undefined,OPT.AUTO_ANY);
	serenade.global().key("echo", "e",undefined,OPT.AUTO_ANY);
	serenade.global().key("foxtrot", "f",undefined,OPT.AUTO_ANY);
	serenade.global().key("golf", "g",undefined,OPT.AUTO_ANY);
	serenade.global().key("hotel", "h",undefined,OPT.AUTO_ANY);
	serenade.global().key("india", "i",undefined,OPT.AUTO_ANY);
	serenade.global().key("juliet", "j",undefined,OPT.AUTO_ANY);
	serenade.global().key("kilo", "k",undefined,OPT.AUTO_ANY);
	serenade.global().key("lima", "l",undefined,OPT.AUTO_ANY);
	serenade.global().key("mike", "m",undefined,OPT.AUTO_ANY);
	serenade.global().key("november", "n",undefined,OPT.AUTO_ANY);
	serenade.global().key("oscar", "o",undefined,OPT.AUTO_ANY);
	serenade.global().key("papa", "p",undefined,OPT.AUTO_ANY);
	serenade.global().key("quebec", "q",undefined,OPT.AUTO_ANY);
	serenade.global().key("romeo", "r",undefined,OPT.AUTO_ANY);
	serenade.global().key("sierra", "s",undefined,OPT.AUTO_ANY);
	serenade.global().key("tango", "t",undefined,OPT.AUTO_ANY);
	serenade.global().key("uniform", "u",undefined,OPT.AUTO_ANY);
	serenade.global().key("victor", "v",undefined,OPT.AUTO_ANY);
	serenade.global().key("whiskey", "w",undefined,OPT.AUTO_ANY);
	serenade.global().key("x-ray", "x",undefined,OPT.AUTO_ANY);
